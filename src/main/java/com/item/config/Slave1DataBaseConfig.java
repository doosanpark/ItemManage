...
@Configuration 
@MapperScan(value="com.item.mapper.oracle", sqlSessionFactoryRef="slave1SqlSessionFactory") 
@EnableTransactionManagement 
public class Slave1DataBaseConfig { 
	
	@Bean(name="slave1DataSource")
	@ConfigurationProperties(prefix="spring.slave-1.datasource")
	public DataSource slave1DataSource() { //application.properties에서 정의한 DB 연결 정보를 빌드 
	...
	public SqlSessionFactory slave1SqlSessionFactory(
		...
		DataSource slave1DataSource, ApplicationContext applicationContext) throws Exception{ 
